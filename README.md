# Проект по автоматизации тестовых сценариев на сайте reqres
## :scroll: Содержание:
...
clean test
```
При выполнении данной команды тесты запустятся в Jenkins
...
<p align="center">
<img width="70%" title="Telegram Notifications" src="images/screens/telegramNotifications.png">
</p>
